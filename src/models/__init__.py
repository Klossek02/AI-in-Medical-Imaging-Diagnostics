...
models = {
    ...
    'segformer_resnet34': lambda device, in_channels, classes, base_c, bilinear, **kwargs: smp.Segformer(encoder_name='resnet34', in_channels=in_channels, classes=classes).to(device)
}
